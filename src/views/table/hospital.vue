  ...
  <Col>
    <Row>
      ...
      <Col align="right" span="18" style="margin-top: 10px">
        <Form v-model="form">
          <Input placeholder="医院名称" style="width:100px" v-model="form.hospitalName"/>
          <Input placeholder="医院编码" style="width:100px" v-model="form.code"/>
          <Input placeholder="医院等级" style="width:100px" v-model="form.level"/>
          <Input placeholder="医院电话" style="width:100px" v-model="form.telephone"/>
          <Input placeholder="医院地址" style="width:100px" v-model="form.address"/>
          ...
          <Button @click="addhospitalmodal = true" class="icon" shape="circle" size="large" type="primary">
            <Icon type="md-add"/> &nbsp;&nbsp;
            添加
          </Button>
        </Form>
